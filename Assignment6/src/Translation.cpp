...
// mutable lamda expression to genrate unit dirction vector
    auto createUnitVector = [this]()mutable
    {
    ...
    Point3D unitVecPoint = createUnitVector();
...
auto createUnitVector = [] (Point3D dirVector) mutable
{
